...
const noticesData = [
  {
    id: 1,
    title: "[긴급] 오늘 18시부터 2시간 단수 예정",
    date: "2026.06.26",
    content:
      "단지 내 저수조 청소 및 유입 밸브 교체 작업으로 인해 오늘 저녁 18시부터 20시까지 약 2시간 동안 전 세대 단수가 진행될 예정입니다. 입주민 여러분께서는 세수 및 취사에 필요한 생활용수를 미리 충분히 확보해 두시기 바라며, 단수 시간 중에는 세탁기 가동 및 비데 사용을 자제해 주시길 부탁드립니다. 단수 후 최초 통수 시 녹물이 나올 수 있으니 잠시 물을 흘려보낸 후 사용해 주세요.",
  },
  {
    id: 2,
    title: "[공지] 헬스장 정기 점검 안내",
    date: "2026.06.25",
    content:
      "커뮤니티 센터 지하 1층에 위치한 주민 헬스장의 운동 기구 전반에 대한 정기 윤활 작업 및 안전 부품 점검이 6월 28일 일요일 오전 9시부터 오후 3시까지 진행됩니다. 해당 시간 동안에는 안전을 위해 헬스장 입장이 전면 통제되오니 이용에 참고하시기 바랍니다. 더욱 안전하고 쾌적한 피트니스 공간을 위해 정기 검사에 협조해 주셔서 대단히 감사합니다.",
  },
  {
    id: 3,
    title: "[안내] 6월 관리비 고지서가 발행됐어요",
    date: "2026.06.24",
    content:
      "6월 아파트 관리비 고지서가 정상 발행되었습니다. 스마트홈 마이홈 리포트 메뉴에서 상세 사용 내역을 확인 및 전월 대비 증감 현황을 조회하실 수 있습니다. 관리비 납부 마감일은 6월 30일까지이며, 연체료가 발생하지 않도록 지정된 가상 계좌 또는 자동이체 계좌의 잔액을 점검해 주시길 당부드립니다. 문의 사항은 관리소 정산계로 연락해 주세요.",
  },
  {
    id: 4,
    title: "[알림] 지하주차장 B2 청소 일정 안내",
    date: "2026.06.23",
    content:
      "단지 청결 유지를 위해 지하 주차장 2층 구역 물청소가 6월 29일 월요일 오전 10시부터 오후 4시까지 순차적으로 진행됩니다. 청소 시간 중에는 물 분사 및 청소 장비 작동으로 인해 차량 오염 및 미끄럼 사고 우려가 있으니, 가급적 해당 일시에 주차된 모든 차량을 지하 1층 주차 구역으로 미리 이동 주차해 주시기를 협조 부탁드립니다.",
  },
];
...
let votesData = [
  {
    ...
    options: [
      {
        id: 1,
        name: "기호 1번 김철수 (102동 402호)",
        description:
          "경력: 단지 조경 정비 위원회 위원장 / 공약: 주차 공간 및 단지 내 화단 집중 개선",
      },
      {
        id: 2,
        name: "기호 2번 이영희 (102동 1105호)",
        description:
          "경력: 부녀회 총무 3년 / 공약: 커뮤니티 도서관 활성화 및 야간 보완 순찰 강화",
      },
    ],
    totalVoters: 250,
    votedCount: 142,
  },
  {
    ...
    options: [
      {
        id: 1,
        name: "찬성 (매일 13:00 ~ 18:00 가동)",
        description: "하절기 무더위 해소 및 단지 조경 가치 향상",
      },
      {
        id: 2,
        name: "반대 (기존대로 주말만 가동)",
        description: "공동 수도 요금 및 전기세 관리비 상승 우려",
      },
    ],
    totalVoters: 500,
    votedCount: 388,
  },
  {
    ...
    options: [
      {
        id: 1,
        name: "A엘리베이터 케어 (낙찰가 최저) 동의",
        description: "92% 득표율로 가결 (찬성 386표 / 반대 34표)",
      },
      {
        id: 2,
        name: "B승강기 시스템 (낙찰가 차순위) 동의",
        description: "8% 득표율",
      },
    ],
    totalVoters: 500,
...
let boardPosts = [
  {
    ...
    content:
      "오늘 아침 출근길에 지하 2층 주차장 주차 기둥 B-12 구역 뒤편에서 하얗고 귀여운 고양이를 발견했어요. 목걸이를 차고 있는 걸로 봐서 혹시 단지 내에서 가출한 반려묘가 아닌가 걱정이 됩니다. 너무 조심성이 많아서 제가 츄르를 챙겨서 조심스럽게 다가가 보았는데, 경계하면서 순식간에 차 밑으로 숨어버렸네요.\n\n혹시 103동이나 104동 근처 주차장 근처에서 해당 고양이를 잃어버리신 차주분이나 주인분이 계시다면 빨리 가셔서 확인해 보시는 게 좋을 것 같습니다. 지하주차장이 차들이 수시로 드나들어 위험해 보이더라고요. 혹시 추가로 목격하신 분이 있다면 다른 장소라도 댓글로 꼭 알려주세요!",
    commentsList: [
      {
        author: "주민B (102동)",
        time: "2026.06.26 09:20",
        content: "좋은 정보 정말 감사합니다! 얼른 주인을 찾았으면 좋겠네요.",
      },
      {
        author: "주민C (104동)",
        time: "2026.06.26 09:22",
        content:
          "방금 출근하면서 104동 근처 자전거 보관소 앞 화단 풀숲에서 비슷한 고양이가 웅크리고 있는 것을 보았습니다. 다행히 다치진 않은 것 같아 보였어요!",
      },
      {
        author: "주민D (103동)",
        time: "2026.06.26 09:25",
        content:
          "아, 저희 윗집 강아지 키우시는 분인데 고양이도 함께 키우시는 걸로 알아요. 혹시 그 댁 고양이인지 얼른 물어보고 연락해 봐야겠네요. 글 올려주셔서 진심으로 고맙습니다!",
      },
    ],
  },
  {
    ...
    content:
      "안녕하세요, 입주민 여러분! 며칠 전에 정문 앞에 새로 생긴 신상 베이커리 빵집에 들러보았는데요. 시그니처 메뉴인 소금빵을 사 먹었는데 기대 이상으로 너무 훌륭해서 후기를 남겨봅니다.\n\n겉은 아주 바삭바삭하면서 버터향이 풍부하고, 속은 쫄깃하고 촉촉해서 따뜻한 아메리카노랑 궁합이 정말 최고더라고요. 가격도 개당 2,500원 수준으로 꽤 합리적인 편입니다. 사장님께 여쭤보니 매일 오후 2시랑 5시에 빵이 구워져 나온다고 해요. 갓 구운 빵 드시고 싶으신 분들은 시간 잘 맞춰서 방문하시면 인생 소금빵을 맛보실 수 있을 거예요! 맛있는 동네 가게는 널리 알려야죠 ㅎㅎ",
    commentsList: [
      {
        author: "주민E (101동)",
        time: "2026.06.26 08:35",
        content:
          "저도 소문 듣고 어제 퇴근길에 가봤는데 5시 30분쯤에 가니까 품절이었어요 ㅜㅜ 오늘 주말이니 점심 지나서 일찍 사러 가볼 생각이에요!",
      },
      {
        author: "주민F (105동)",
        time: "2026.06.26 08:42",
        content:
          "소금빵 말고도 크루아상이랑 단팥빵도 먹을 만하더라고요! 전체적으로 사장님이 정직하게 밀가루랑 버터를 좋은 것 쓰시는 게 느껴져서 단골 될 것 같습니다.",
      },
    ],
  },
  {
    ...
    content:
      "아이들이 자라서 안 입는 옷들이랑 한두 번밖에 안 가지고 논 깨끗한 보드게임, 장난감들이 꽤 많이 쌓였네요. 버리기는 너무 아깝고 해서 아파트 부녀회나 관리사무소에서 주기적으로 주최하던 단지 내 벼룩시장에 참여해보고 싶습니다. 작년 가을쯤에 중앙광장에서 열렸던 기억이 나는데 혹시 이번 상반기나 여름에 개최 일정이 잡혀있는지 정확히 아시는 분 계시면 알려주세요!",
    commentsList: [
      {
        author: "주민H (106동)",
        time: "2026.06.25 19:02",
        content:
          "관리사무소 게시판에서 얼핏 봤는데, 7월 둘째 주 토요일 오후 1시부터 수경광장 근처에서 벼룩시장이 열린다고 안내되어 있었어요!",
      },
      {
        author: "주민G (102동)",
        time: "2026.06.25 19:10",
        content:
          "오! 친절한 정보 정말 감사드려요. 미리 물건들 잘 챙겨놓고 준비해야겠네요.",
      },
    ],
  },
  {
    ...
    content:
      "아이가 이제 막 걸음마를 떼기 시작하면서 거실에서 쿵쿵거리는 소리가 꽤 크게 나기 시작하네요. 아랫집 이웃분께 너무 죄송하기도 하고 서로 스트레스 받지 않으려면 거실 전체에 소음 방지 매트를 아예 제대로 시공하는 게 낫겠다 싶어서 알아보고 있습니다. 혹시 입주민분들 중에서 최근에 셀프 시공 말고 전문 업체 불러서 매트 깔아보신 댁 있으신가요? 냄새도 안 나고 깔끔하게 코너 마무리 잘해주는 검증된 업체 있으면 추천 좀 부탁드려요!",
    commentsList: [
      {
        author: "주민J (102동)",
        time: "2026.06.25 14:30",
        content:
          "저희도 똑같은 고민 하다가 지난달에 롤매트 시공 받았는데 진짜 100% 만족 중이에요! 쪽지 주시면 시공 업체명이랑 단가 정보 보내드릴게요.",
      },
      {
        author: "주민K (103동)",
        time: "2026.06.25 14:45",
        content:
          "시공 매트 까는 거 정말 강추예요. 미관상으로도 요즘은 타일처럼 깔끔하게 잘 나와서 거실이 오히려 넓어 보이고 좋습니다.",
      },
    ],
  },
  {
    ...
    content:
      "매일 아침 7시 40분쯤에 단지 정문 주차장에서 출발해서 분당수서간고속화도로 타고 판교 테크노밸리(H스퀘어 부근)까지 자차로 출퇴근하고 있는 직장인입니다. 혼자 운전해서 가는데 기름값도 조금 아끼고 출근 메이트 삼아서 카풀 하실 입주민 분이 계시는지 여쭤봅니다. 주 5일 고정 참석 아니어도 괜찮으니 편하게 생각 있으신 분들은 댓글 남겨주시거나 개인 톡으로 연락해 주세요!",
    commentsList: [
      {
        author: "주민L (101동)",
        time: "2026.06.24 22:30",
        content:
          "와! 저 삼평동 회사인데 시간대가 딱 맞네요! 매달 카풀비 꼬박 입금해 드리고 조용히 탑승 가능합니다. 상세 내용 조율해 보고 싶습니다!",
      },
    ],
  },
  {
    ...
    content:
      "아이가 이제 많이 자라 유모차 탈 일이 없어져서 단지 내 필요하신 이웃분께 무료 나눔 하려고 합니다. 절충형 유모차이고 실사용 기간은 1년 남짓이라 바퀴 마모 상태도 양호하고 시트 커버도 주기적으로 세탁해서 무척 깨끗합니다. 레인 커버랑 컵홀더 부속품도 다 챙겨드릴게요. 106동 공동현관문 앞으로 직접 가지러 오실 수 있는 분 연락 주세요! 가급적 오늘 저녁에 거래 가능하신 분 우대합니다.",
    commentsList: [
      {
        author: "주민N (104동)",
        time: "2026.06.24 16:38",
        content:
          "신청해봅니다! 마침 둘째 유모차가 망가져서 새로 사려던 참인데 기회 주시면 유용하게 쓰겠습니다. 106동 앞으로 바로 가겠습니다!",
      },
    ],
  },
  {
    ...
    content:
      "아침 시간대에 커뮤니티 지하 피트니스 센터를 자주 이용하고 있는 입주민입니다. 요즘 날씨가 더워지고 습해지면서 실내 운동하시는 분들이 급증했는데, 땀 냄새가 잘 안 빠지고 환기가 덜 되어 지하 공기가 꽤 꿉꿉하고 답답하게 느껴집니다. 환풍기를 추가 가동하거나 공기청정기 필터 청소 주기를 좀 더 단축해 줄 것을 관리사무소 건의 게시판에 올리려고 하는데 다들 동의하시는지 의견 여쭙고 싶습니다.",
    commentsList: [
      {
        author: "주민P (105동)",
        time: "2026.06.23 11:45",
        content:
          "백번 공감합니다. 저녁 퇴근 시간대에는 진짜 습하고 공기가 텁텁해요. 강력히 청원 올려주시면 저도 댓글 달아 서명할게요!",
      },
    ],
  },
  {
    ...
    content:
      "어제 수경광장 수영 분수가 가동되는 걸 보고 저희 집 아이들이 달려 나가서 한바탕 신나게 물놀이를 즐겼습니다. 단지 관리가 늘 깔끔하고 깨끗한 물로 가동해 주시는 보안 및 환경 미화 선생님들께 진심으로 깊이 감사드립니다. 우리 아파트 중앙광장 뷰는 볼 때마다 정말 힐링이 되는 것 같아 주민으로서 대단히 자랑스럽습니다.",
    commentsList: [],
  },
  {
    id: 9,
    ...
    content:
      "오늘 저녁에 101동 뒤편 자전거 거치대 옆 잔디밭 구석에 파란색 자이언트 하이브리드 자전거 한 대가 체인 잠금장치가 풀려진 채 덩그러니 쓰러져 있는 것을 발견했습니다. 혹시 잃어버리고 찾아 헤매고 계신 차주분이 있다면 경비실에 분실 보관 의뢰해 두었으니 거기로 가셔서 동 호수 확인하시고 수령하시기 바랍니다. 도난 의심이 좀 들기도 하네요.",
    commentsList: [
      {
        author: "주민S (101동)",
        time: "2026.06.22 21:05",
        content:
          "앗! 제 동생 자전거인 것 같습니다! 어제 세워두고 체인을 제대로 안 채운 것 같다며 하루 종일 안달복달했는데, 경비실 연락해서 확인해보겠습니다. 제보 정말 감사합니다!",
      },
    ],
  },
  {
    ...
    content:
      "주말마다 캠핑 갈 때 유용하게 쓰려고 콜맨 캠핑 웨건을 구매하려는데, 1년에 실제로 쓰는 횟수는 5~6번 남짓이라 혼자 다 부담해서 사고 보관하기엔 집 안 공간도 차지하고 비효율적이네요. 혹시 캠핑이나 짐 나를 때 가끔 웨건 필요하신 근처 라인 입주민 분이 계시다면, 1/n로 공동 부담해서 구매 후 복도 자전거 보관 구역에 두고 일정 스케줄 관리하면서 셰어링 형태로 이용하실 분 계시면 좋겠습니다. 관심 있으신 분은 댓글이나 편하게 제안 주십시오!",
    commentsList: [],
  },
];

let clubSearchQuery = "";
let selectedClubToJoin = null;
let userClubs = [
  {
    id: 1,
    name: "아파트 야간 러닝 크루",
...
const clubNoticesData = [
  {
    id: 1,
    title: "이번 주 토요일(27일) 정기 러닝 집결 안내",
    date: "2026.06.26",
    content:
      "이번 주 토요일 저녁 8시 정기 야간 러닝은 예정대로 아파트 정문 수경광장 분수대 앞에서 모여 출발합니다. 날씨 예보를 보니 구름만 다소 끼고 선선하여 러닝하기 아주 좋은 컨디션일 것 같습니다. 당일 기온은 약 22도 수준이므로 얇은 기능성 티셔츠 차림을 추천드립니다. 혹시 갑작스러운 소나기 등 우천 발생 시 가동 여부는 당일 오후 6시까지 단톡방과 본 공지글 댓글 피드로 신속히 재안내해 드릴게요. 다들 늦지 않게 나와주세요!",
  },
  {
    id: 2,
    title: "하절기 러닝 페이스메이커 자원봉사 모집",
    date: "2026.06.22",
    content:
      "러닝 크루 회원이 늘어남에 따라 페이스별(킬로당 5분, 6분, 7분 페이스) 그룹 달리기를 진행하려고 합니다. 안전한 대열 주행과 낙오자 방지를 위해 각 페이스 그룹을 이끌어주실 든든한 페이스메이커 자원봉사 주민분들을 선착순 모집합니다. 봉사해 주시는 분들께는 크루 회비에서 스포츠 이온음료를 매달 무상 지원해 드려요 ㅎㅎ 많은 지원 부탁드립니다.",
  },
];
...
let clubPosts = [
    ...
    commentsList: [
      {
        ...
        time: "어제",
        content:
          "어제 습도가 높아서 중간에 포기하고 싶었는데, 다 같이 뛰어주신 덕분에 끝까지 달릴 수 있었습니다! 다음 주 호수 코스 정말 시원하고 좋을 것 같아요. 꼭 참석할게요!",
      },
      {
        author: "회원C (104동)",
        time: "어제",
        content:
          "어제 뛰고 나니까 온몸이 개운하네요! 이번에 장만한 가벼운 러닝화가 아주 맘에 듭니다. 다음 주에 본격적으로 테스트해봐야겠어요 ㅎㅎ",
      },
      {
        author: "러너A",
        time: "어제",
        content:
          "방장님 항상 코스 연구해 주시고 페이스 조절 가이드해 주셔서 든든합니다. 다들 고생하셨습니다!",
      },
      {
        author: "방랑자",
        time: "어제",
        content:
          "오랜만에 참석했는데 땀 쭉 빼고 샤워하니까 천국이 따로 없네요. 다음 주에도 무조건 고입니다!",
      },
    ],
  },
  {
    id: 2,
    author: "주민B (102동)",
    title: "초보 러너분들을 위한 안정화 러닝화 득템 후기!",
    time: "2일 전",
    content:
      "이번에 러닝 취미를 본격적으로 시작하면서 새로 산 초보자용 안정화 러닝화를 실전에서 개시해 보았습니다. 발볼이 넓은 편이라 신발 고르기가 참 힘들었는데 발 양옆을 꽉 잡아주고 쿠션감도 푹신해서 달릴 때 무릎에 충격이 확실히 덜 오더라고요! 초보 러너분들 신발 유목민 생활 중이시라면 매장 가셔서 한 번 피팅해 보시길 강력 추천합니다.",
    comments: 2,
    commentsList: [
      {
        author: "러닝장장 (방장)",
        time: "2일 전",
        content:
          "오 대단한 지름이시네요! 모델명이 혹시 어떤 건가요? 제품 정보나 구매처 간단하게 단톡방이나 여기에 공유해주시면 다른 초보 크루 분들께 큰 도움이 될 것 같아요!",
      },
      {
        author: "주민B (102동)",
        time: "2일 전",
        content:
          "아! 나이키 에어 줌 페가수스 시리즈입니다! 아울렛 매장에서 마침 세일 중이라 아주 착한 가격에 득템했어요 ㅎㅎ",
      },
    ],
  },
  {
    id: 3,
    author: "회원C (104동)",
    title: "이번 주 토요일 우천 시 러닝 모임 진행 여부 문의",
    time: "2026.06.24",
    content:
      "이번 주 토요일 저녁 정기 벙개 런 일정에 일기예보를 보니 장마 영향으로 전국에 비 소식이 잡혀 있더라고요. 빗방울이 약하게 날리는 우중 런이면 다 같이 모여 시원하게 달려도 좋을 것 같긴 한데, 혹시 강수량이 많아지면 실내 체육관 조깅 트랙이나 아파트 지하 주차장 트랙 레이아웃으로 변경해서 모임을 진행하는지, 아니면 일정이 취소되는지 궁금합니다.",
    comments: 2,
    commentsList: [
      {
        author: "러닝장장 (방장)",
        time: "2026.06.24",
        content:
          "토요일 강수량이 시간당 5mm 이상 예보되면 안전을 위해 야외 세션은 취소하고 홈트 레이아웃으로 돌리거나 한 주 쉬어 가도록 결정하겠습니다. 당일 아침 기상청 날씨 분석해서 신속히 알려드릴게요!",
      },
      {
        author: "회원C (104동)",
        time: "2026.06.24",
  ...
  },
  {
    id: 4,
    author: "러닝장장 (방장)",
    title: "정기 러닝 코스 안내 (정문 출발 -> 단지 외곽 -> 후문 반환)",
    time: "2026.06.22",
    content:
      "이번 주 정기 러닝 코스는 정문에서 출발하여 외곽 도로를 거쳐 후문에서 반환하는 코스로 정해졌습니다. 상세 지도 이미지를 참고하세요.",
    comments: 1,
    commentsList: [
      {
        author: "주민B (102동)",
...
const menuRow = (icon, title, sub, to) =>
  `<button class="menu-row" data-route="${to}"><span>${icon}</span><span><b>${title}</b><small>${sub}</small></span><i>›</i></button>`;
...
function home() {
  return `<section class="page">
    ...
    <div class="summary-grid">
      ...
      <button class="card summary-card" id="homeDoorBtn"><div class="visual">${icon(deviceState.door ? "lock" : "unlock")}</div><h3>공동 현관문 제어</h3><p id="homeDoorStatus">${deviceState.door ? "안전하게 잠김" : "열려 있음"}</p></button>
    </div>
...
function life() {
  return `<section class="page">${pageTitle("생활", "자주 쓰는 아파트 서비스를 모았어요.")}
  <div class="section-head"><h2>자주 쓰는 기능</h2></div><div class="quick-grid">
  ${[
    [icon("calendar"), "시설예약", "reservation"],
    [icon("car-side"), "방문차량", "visitor"],
    [icon("bulb"), "스마트홈 제어", "control"],
    [icon("parking"), "주차 현황", "parking"],
  ]
    .map(
      (x) =>
        `<button class="quick" data-route="${x[2]}"><span>${x[0]}</span>${x[1]}</button>`,
    )
    .join("")}</div>
...
function community() {
  ...
  // 새로운 소모임 가입하기 필터
  const filteredAvailableClubs = availableClubs.filter(
    (c) =>
      c.name.toLowerCase().includes(query) ||
      c.desc.toLowerCase().includes(query),
  );

  const userClubsHtml = filteredUserClubs
    .map(
      (c) => `
    <div class="card" style="border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow); padding: 16px; margin-top: 10px; display: flex; flex-direction: column; gap: 8px;">
      ...
      <div style="display: flex; justify-content: flex-end; margin-top: 4px;">
        <button class="join-chat-btn" data-route="clubDetail" style="background: var(--cream); border: 1px solid var(--line); color: var(--ink); font-size: 11px; padding: 6px 12px; border-radius: 8px; font-weight: 700; cursor: pointer; transition: all 0.2s ease;">모임 입장</button>
      </div>
    </div>
  `,
    )
  ...
  const availableClubsHtml = filteredAvailableClubs
    .map((c, idx) => {
  ...
  return simplePage(
    ...
    <div class="card" style="border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow); overflow: hidden; display: flex; flex-direction: column; gap: 0;">
      ...
      <div class="club-post-item-link" data-id="${clubPosts[0].id}" style="padding: 16px; border-bottom: 1px solid var(--line); display: flex; flex-direction: column; gap: 8px; cursor: pointer;">
        ...
        <div style="font-size: 13.5px; color: var(--ink); font-weight: 700; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
          ${clubPosts[0].title || "제목 없음"}
        </div>
...
function clubBoard() {
  ...
  const filteredPosts = clubPosts.filter(
    (p) =>
...
function clubBoardWrite() {
  return simplePage(
    ...
    <div class="card form-card" style="padding: 20px; border-radius: 12px; border: 1px solid var(--line); box-shadow: var(--shadow);">
      ...
      <div class="field" style="margin-bottom: 16px;">
        <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ink); margin-bottom: 6px;">제목</label>
        <input type="text" id="clubWriteTitle" placeholder="글 제목을 입력해 주세요." style="width: 100%; border: 1px solid var(--line); background: #ffffff; padding: 10px 12px; border-radius: 8px; font-size: 13px; outline: none; font-weight: 500;">
      </div>
...
function bindClubBoardWriteEvents() {
  ...
  if (submitBtn) {
    submitBtn.onclick = () => {
      ...
      const title = $("#clubWriteTitle").value.trim();
...
function clubBoardDetail() {
  const post =
    clubPosts.find((p) => p.id === selectedClubPostId) || clubPosts[0];
  ...
  return simplePage(
    ...
    <div class="card" style="padding: 20px; border-radius: 12px; border: 1px solid var(--line); box-shadow: var(--shadow); margin-bottom: 24px; display: flex; flex-direction: column; gap: 14px;">
      <div style="font-size: 15px; font-weight: 700; color: var(--ink); line-height: 1.4;">${post.title || "제목 없음"}</div>
      <div style="display: flex; justify-content: space-between; align-items: center; font-size: 12.5px;">
...
function clubNoticeDetail() {
  const item =
    clubNoticesData.find((n) => n.id === currentClubNoticeId) ||
    clubNoticesData[0];
  const listHtml = clubNoticesData
    .map((n, idx) => {
...
function clubBoardEdit() {
  ...
  return simplePage(
    ...
    <div class="card form-card" style="padding: 20px; border-radius: 12px; border: 1px solid var(--line); box-shadow: var(--shadow);">
      ...
      <div class="field" style="margin-bottom: 16px;">
        <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ink); margin-bottom: 6px;">제목</label>
        <input type="text" id="clubEditTitle" value="${post.title || ""}" placeholder="글 제목을 입력해 주세요." style="width: 100%; border: 1px solid var(--line); background: #ffffff; padding: 10px 12px; border-radius: 8px; font-size: 13px; outline: none; font-weight: 500;">
      </div>
...
function bindClubBoardEditEvents() {
  ...
  if (submitBtn) {
    submitBtn.onclick = () => {
      const title = $("#clubEditTitle").value.trim();
  ...
  const devices = [
    {
      ...
      iconName: "bulb",
      name: "거실 조명",
      desc: deviceState.livingLight ? "켜짐" : "꺼짐",
      on: deviceState.livingLight,
    },
    {
      id: "ac",
      iconName: "air-conditioner",
      name: "에어컨",
      desc: deviceState.ac ? "쾌적 냉방 · 23℃" : "꺼짐",
      on: deviceState.ac,
    },
    {
      id: "gas",
      iconName: "flame",
      name: "가스 밸브",
      desc: deviceState.gas ? "안전하게 잠김" : "열림",
      on: !deviceState.gas,
    },
  ];
...
function bindControlEvents() {
  ...
  if (livingLightSwitch) {
    livingLightSwitch.onclick = () => {
      ...
      if (livingLightDesc)
        livingLightDesc.textContent = deviceState.livingLight ? "켜짐" : "꺼짐";
      toast(
        deviceState.livingLight
          ? "거실 조명을 켰습니다."
          : "거실 조명을 껐습니다.",
      );
    };
  ...
  if (acSwitch) {
    acSwitch.onclick = () => {
      ...
      if (acDesc)
        acDesc.textContent = deviceState.ac ? "쾌적 냉방 · 23℃" : "꺼짐";
      toast(
        deviceState.ac ? "에어컨 전원을 켰습니다." : "에어컨 전원을 껐습니다.",
      );
    };
  }
  ...
  if (gasSwitch) {
    gasSwitch.onclick = () => {
      ...
      if (gasDesc)
        gasDesc.textContent = deviceState.gas ? "안전하게 잠김" : "열림";
      toast(
        deviceState.gas
          ? "가스 밸브를 잠갔습니다 (안전)."
          : "가스 밸브를 열었습니다.",
...
function my() {
  return `<section class="page">${pageTitle("마이", "우리 집과 내 활동을 관리해요.")}
...
function simplePage(title, sub, body) {
  return `<section class="page">${pageTitle(title, sub)}${body}</section>`;
}
...
const facilities = {
  회의실A: {
    ...
    location: "커뮤니티 센터 1층",
    price: "시간당 5,000원",
    reserved: ["11:00", "14:00", "15:00"],
  },
  회의실B: {
    maxHours: "최대 3시간",
    location: "커뮤니티 센터 1층",
    price: "시간당 5,000원",
    reserved: ["10:00", "13:00", "16:00"],
  },
  골프룸A: {
    maxHours: "최대 2시간",
    location: "스포츠 센터 B1층",
    price: "시간당 15,000원",
    reserved: ["09:00", "10:00", "19:00", "20:00"],
  },
  골프룸B: {
    maxHours: "최대 2시간",
    location: "스포츠 센터 B1층",
    price: "시간당 15,000원",
    reserved: ["11:00", "15:00", "18:00"],
  },
};
...
function reservation() {
  ...
  const chipHtml = Object.keys(facilities)
    .map(
      (name) =>
  ...
  const timeHtml = times
    .map((t) => {
      ...
      const isSelected =
        Array.isArray(reservState.time) && reservState.time.includes(t);
...
function bindReservationEvents() {
  ...
  $$(".time-slot:not([disabled])").forEach(
    (b) =>
      (b.onclick = () => {
  ...
  if (submitBtn) {
    submitBtn.onclick = () => {
      ...
      const newBooking = {
        ...
        iconName: reservState.facility.startsWith("회의실")
          ? "calendar"
          : "golf-ball",
        status: "upcoming",
        statusText: "이용 예정",
        ...
        hasActions: true,
        qrCodeData: `${reservState.facility}_booking_${Date.now()}`,
      };
      ...
      toast(
        `${reservState.facility} 예약이 완료됐어요. (${reservState.date} ${formattedTimes})`,
      );
      reservState.time = [];
      setTimeout(() => {
...
let bookings = [
  {
    ...
    people: "4명",
    hasActions: true,
    qrCodeData: "meeting-room-A-booking-1",
  },
  {
    id: 2,
    facility: "골프룸A",
    ...
    people: null,
    hasActions: false,
    qrCodeData: "golf-room-A-booking-2",
  },
  {
    id: 3,
    facility: "골프룸B",
    ...
    people: null,
    hasActions: false,
    qrCodeData: "golf-room-B-booking-3",
  },
];
...
function bookingList() {
  ...
  const listHtml = filteredBookings
    .map((b) => {
    ...
    (b) =>
      ...
      <div class="qr-modal-content">
        ...
        <div class="qr-container">
          <img 
            src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=${encodeURIComponent(bk.qrCodeData || "booking_" + bk.id)}" 
            alt="예약 인증 QR코드" 
...
function visitor() {
  return simplePage(
    ...
    <div class="card form-card">
      ...
      <div class="field">
        <label>방문자명</label>
        <input id="visitorName" placeholder="예: 홍길동" value="">
      </div>
      <div class="field">
        <label>방문일</label>
...
function bindVisitorEvents() {
  ...
  if (submitBtn) {
    submitBtn.onclick = () => {
      ...
      const visitorName = $("#visitorName").value.trim();
  ...
  if (favVehiclesBtn) {
    favVehiclesBtn.onclick = () => {
      ...
      `,
              ...
              .join("")
          : `<div style="padding: 24px; text-align: center; color: var(--sub); font-size: 12.5px;">등록된 단골차량이 없습니다.</div>`;
...
function visitorList() {
  const listHtml = visitorVehicles
    .map((v) => {
      ...
      <div class="card visitor-item-card" data-status="${v.status}">
        ...
        <div class="visitor-card-body">
          ...
          <div class="visitor-detail-row">
            <span class="dot">•</span>
            <span class="label">방문자명 :</span>
            <span class="value">${v.visitorName}</span>
          </div>
          `
              : ""
          }
...
function parking() {
  return simplePage(
    ...
    `<div class="summary-grid">${[
      ...
      .map(
        (x) =>
          `<div class="card summary-card"><div class="visual">P</div><h3>${x[0]}</h3><p>${x[1]} 여유</p></div>`,
      )
      .join(
        "",
      )}</div><div class="section-head"><h2>내 차 찾기</h2></div><div class="card form-card"><div class="field"><label>차량번호</label><input id="carSearch" value="12가 3456"></div><button class="primary" id="searchCar">위치 확인</button><div id="carResult"></div></div>`,
  );
}
const feeData = {};
for (let year = 2024; year <= 2026; year++) {
  ...
  for (let m = 1; m <= maxMonth; m++) {
    ...
    const details = [
      [
        "전기료",
        `${(Math.round((baseAmt * 0.27) / 100) * 100).toLocaleString()}원`,
      ],
      [
        "수도료",
        `${(Math.round((baseAmt * 0.12) / 100) * 100).toLocaleString()}원`,
      ],
      [
        "난방비",
        m >= 11 || m <= 3
          ? `${(Math.round((baseAmt * 0.18) / 100) * 100).toLocaleString()}원`
          : "0원",
      ],
      [
        "일반관리비",
        `${(Math.round((baseAmt * 0.4) / 100) * 100).toLocaleString()}원`,
      ],
      [
        "수선유지비",
        `${(Math.round((baseAmt * 0.1) / 100) * 100).toLocaleString()}원`,
      ],
    ];
    let sum = details.reduce(
      (acc, curr) =>
        acc + parseInt(curr[1].replace(/,/g, "").replace("원", "")),
      0,
    );
...
function fee() {
  ...
  `;
  const autoPayHtml = data.isAutoPay
    ? `<span class="fee-autopay-badge">자동이체</span>`
    : "";
...
function openPicker(selectedYear, selectedMonth, onSelect) {
  ...
  pickerEl.querySelector("#pickerDoneBtn").onclick = () => {
    const yrScrollIdx = Math.min(
      Math.max(Math.round(yearCol.scrollTop / itemHeight), 0),
      years.length - 1,
    );
    const moScrollIdx = Math.min(
      Math.max(Math.round(monthCol.scrollTop / itemHeight), 0),
      months.length - 1,
    );
  ...
  const updateSelection = (col) => {
    ...
    const activeIndex = Math.min(
      Math.max(Math.round(col.scrollTop / itemHeight), 0),
      items.length - 1,
    );
...
let complaints = [
  {
    ...
    dateValue: "6월 26일",
    steps: [
      { name: "접수 대기", date: "6/26", active: true, current: true },
  ...
  },
  {
    ...
    answer:
      "순차적으로 전등 교체 작업 중입니다. 금일 오후 내로 조치하겠습니다.",
    expanded: false,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    dateValue: "6월 10일",
    result:
      "공동현관문 유격 조절 및 하부 힌지 윤활유 보강 작업이 완료되었습니다.",
    expanded: false,
  },
  {
    id: 4,
    ...
    dateValue: "6월 5일",
    result:
      "분리수거장 소독 작업을 주기적으로 실시하도록 일정을 단축하였으며, 탈취 설비 점검이 완료되었습니다.",
    expanded: false,
  },
];
...
function complaint() {
  ...
  const listHtml = sliced
    ...
    `;
      ...
      `;
        ...
        feedbackHtml = `
        <div class="complaint-answer-box" style="background: #faf8f5;">
          <div class="complaint-answer-title" style="color: var(--sub);">
            <span>${icon("info-circle")}</span>
            <b>취소 상태:</b>
          </div>
          <div class="complaint-answer-text" style="color: var(--sub);">입주민 요청으로 접수가 취소된 민원입니다.</div>
        </div>
      `;
      } else if (c.answer) {
        feedbackHtml = `
      ...
      if (c.status === "waiting") {
        actionButtons = `
        <div class="complaint-card-actions" style="display: flex; justify-content: flex-end; margin-top: 14px; border-top: 1px solid var(--line); padding-top: 12px;">
          <button class="action-complaint-cancel" data-id="${c.id}" style="padding: 8px 16px; font-size: 12px; font-weight: 700; border-radius: 8px; border: 1px solid var(--line); background: var(--cream); color: var(--ink); cursor: pointer; transition: all 0.2s;">접수 취소</button>
        </div>
      `;
      }
      ...
      <div class="complaint-item-card ${c.expanded ? "expanded" : "collapsed"}" data-id="${c.id}">
        <div class="complaint-card-trigger" style="cursor: pointer; display: flex; justify-content: space-between; align-items: center;">
          <h3 style="margin: 0; font-size: 14px; font-weight: 700;">${icon(c.iconName)} ${c.title}${c.status === "completed" ? " (처리 완료)" : c.status === "cancelled" ? " (취소됨)" : ""}</h3>
  ...
  const showMoreBtn =
    complaints.length > visibleComplaintsCount
      ? `
...
function bindComplaintEvents() {
  ...
  $$(".action-complaint-cancel").forEach(
    (b) =>
      (b.onclick = (e) => {
        e.stopPropagation();
        const id = parseInt(b.dataset.id);
      ...
      <div class="confirm-modal-content">
        <h2>민원 접수 취소</h2>
        <p>정말로 이 민원 접수를 취소하시겠습니까?</p>
        <div style="display:flex; gap:10px; margin-top:20px;">
          <button class="primary" id="confirmComplaintCancelButton" style="flex:1; background:#d64545 !important; color:#ffffff; border:none; border-radius:8px; padding:12px; font-weight:700; cursor:pointer;">네, 취소합니다</button>
          <button class="secondary" onclick="closeModal()" style="flex:1; border: 1px solid var(--line) !important; background: var(--cream) !important; border-radius: 8px; padding: 12px; font-weight: 700; cursor:pointer;">아니오</button>
        </div>
      </div>
    `);

        const confirmBtn = $("#confirmComplaintCancelButton");
        if (confirmBtn) {
          confirmBtn.onclick = () => {
            c.status = "cancelled";
            c.statusText = "취소됨";
            closeModal();
            toast("민원 접수가 취소되었습니다.");
            $("#app").innerHTML = complaint();
            bindComplaintEvents();
          };
        }
...
const meetingMinutesData = [
  {
    id: 1,
    title: "제24회 정기 입주자대표회의 결과 공고",
    date: "06/15",
    content:
      "어린이 놀이터 모래 소독 및 시소 안장 교체 건, 단지 내 도색 공사 일정이 의결되었습니다.",
  },
  {
    id: 2,
    title: "제23회 임시 입주자대표회의 결과 공고",
    date: "05/20",
    content:
      "지하 주차장 LED 조명 센서 조정 및 관리실 화재 수신기 업그레이드 건이 통과되었습니다.",
  },
  {
    id: 3,
    title: "제22회 정기 입주자대표회의 결과 공고",
    date: "04/18",
    content:
      "봄맞이 조경 정비 계획 및 입주민 도서관 자원봉사자 격려금 편성 건이 의결되었습니다.",
  },
  {
    id: 4,
    title: "제21회 임시 입주자대표회의 결과 공고",
    date: "03/28",
    content:
      "승강기 유지관리 용역 계약 만료에 따른 신규 업체 선정 결과 공지 건입니다.",
  },
  {
    id: 5,
    title: "제18회 정기 입주자대표회의 결과 공고",
    date: "03/10",
    content:
      "어린이 놀이터 바닥 우레탄 유해성 검사 실시 및 보수 건이 최종 승인되었습니다.",
  },
  {
    id: 6,
    title: "제17회 정기 입주자대표회의 결과 공고",
    date: "02/15",
    content:
      "겨울철 동파 예방 설비 보강 및 재활용 쓰레기 수거함 설치 위치 조정 건입니다.",
  },
];
...
function meetingMinutes() {
  ...
  const results = meetingMinutesData.filter(
    (item) =>
      item.title.toLowerCase().includes(query) ||
      item.content.toLowerCase().includes(query),
  );

  const searchNotice = query
    ? `* 검색 결과: '${meetingQuery}'에 대한 결과가 총 ${results.length}건 있습니다.`
    : `* 전체 회의록 목록이 총 ${results.length}건 있습니다.`;
...
function meetingMinutesDetail() {
  const minutes =
    meetingMinutesData.find((x) => x.id === currentMeetingId) ||
    meetingMinutesData[0];
...
let passState = {
  activePasses: [
    {
      facility: "피트니스 센터 (헬스장)",
      period: "2026년 6월 ~ 미정 (자동 연장 중)",
    },
  ],
...
function communityPass() {
  const currentPassesHtml = passState.activePasses
    .map(
      (p) => `
  ...
  const kidsBorder = kidsSelected
    ? "border: 2px solid var(--olive); background: var(--olive);"
    : "border: 1px solid var(--line); background: #ffffff;";

  return simplePage(
    "커뮤니티 정기권",
    "아파트 커뮤니티 시설의 정기 이용권을 신청하고 관리하세요.",
    `
...
function bindCommunityPassEvents() {
  ...
  if (submitBtn) {
    submitBtn.onclick = () => {
      ...
      const alreadyApplied = passState.activePasses.some((p) =>
        p.facility.includes("키즈룸"),
      );
      if (alreadyApplied) {
...
function bindCommunityEvents() {
  ...
  $$(".join-club-btn:not([disabled])").forEach((btn) => {
    btn.onclick = () => {
      ...
      selectedClubToJoin = availableClubs.find((c) => c.id === id);
      navigate("clubJoinApply");
    };
  });
}

function notice() {
  const listHtml = noticesData
    .map((n, idx) => {
...
function noticeDetail() {
  const item =
    noticesData.find((n) => n.id === currentNoticeId) || noticesData[0];
  const listHtml = noticesData
    .map((n, idx) => {
...
function vote() {
  ...
  const tabIngStyle =
    voteTab === "ing"
      ? "border-bottom: 2px solid var(--dark); font-weight: 700; color: var(--ink);"
      : "color: var(--sub);";
  const tabDoneStyle =
    voteTab === "done"
      ? "border-bottom: 2px solid var(--dark); font-weight: 700; color: var(--ink);"
  ...
  return simplePage(
    ...
    <div style="display: flex; justify-content: center; align-items: center; margin-top: 16px; position: relative; min-height: 38px;">
      <div class="meeting-pagination" style="display: flex; align-items: center; gap: 12px;">
        <button class="page-arrow" style="background: none; border: none; font-size: 12px; color: var(--sub); cursor: pointer;" onclick="toast('마지막 페이지입니다.')">◀</button>
        <span class="page-num" style="font-size: 13px; font-weight: 700; color: var(--ink);">1</span>
        <button class="page-arrow" style="background: none; border: none; font-size: 12px; color: var(--sub); cursor: pointer;" onclick="toast('마지막 페이지입니다.')">▶</button>
      </div>
      <button id="voteCreateBtn" style="position: absolute; right: 0; padding: 10px 18px; font-weight: 700; font-size: 12.5px; background: var(--dark) !important; border-radius: 8px; color: #ffffff; cursor: pointer; transition: all 0.2s ease; border: none;">등록</button>
    </div>
  `,
  );
}
...
function voteCreate() {
  return simplePage(
    ...
    <div class="card form-card" style="padding: 20px; border-radius: 12px; border: 1px solid var(--line); box-shadow: var(--shadow);">
      <div class="field" style="margin-bottom: 16px;">
        <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ink); margin-bottom: 6px;">안건 제목</label>
        <input type="text" id="voteCreateTitle" placeholder="안건 또는 선거 제목을 입력해 주세요." style="width: 100%; border: 1px solid var(--line); background: #ffffff; padding: 10px 12px; border-radius: 8px; font-size: 13px; outline: none; font-weight: 500;">
      </div>

      <div class="field" style="margin-bottom: 16px;">
        <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ink); margin-bottom: 6px;">투표 유형</label>
        <div style="display: flex; gap: 16px; background: var(--cream); padding: 12px; border-radius: 8px; border: 1px solid var(--line);">
          <label style="font-size: 12.5px; font-weight: 600; display: flex; align-items: center; gap: 6px; cursor: pointer; color: var(--ink); white-space: nowrap;">
            <input type="radio" name="voteType" value="agree" checked style="accent-color: var(--olive);"> 찬반
          </label>
          <label style="font-size: 12.5px; font-weight: 600; display: flex; align-items: center; gap: 6px; cursor: pointer; color: var(--ink); white-space: nowrap;">
            <input type="radio" name="voteType" value="single" style="accent-color: var(--olive);"> 단일
          </label>
          <label style="font-size: 12.5px; font-weight: 600; display: flex; align-items: center; gap: 6px; cursor: pointer; color: var(--ink); white-space: nowrap;">
            <input type="radio" name="voteType" value="multiple" style="accent-color: var(--olive);"> 중복
          </label>
        </div>
      </div>

      <div class="field" id="voteOptionsField" style="margin-bottom: 16px; display: none;">
        <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ink); margin-bottom: 6px;">선택 항목 (줄바꿈으로 구분)</label>
        <textarea id="voteCreateOptions" placeholder="예:&#10;기호 1번 홍길동&#10;기호 2번 이몽룡" style="width: 100%; height: 100px; border: 1px solid var(--line); border-radius: 8px; padding: 12px; font-size: 13px; outline: none; resize: none; line-height: 1.6; font-family: inherit; font-weight: 500;"></textarea>
      </div>

      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 20px;">
        <div class="field">
          <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ink); margin-bottom: 6px;">시작일</label>
          <input type="date" id="voteCreateStartDate" value="2026-06-28" style="width: 100%; border: 1px solid var(--line); background: #ffffff; padding: 10px 12px; border-radius: 8px; font-size: 13px; outline: none; font-weight: 500;">
        </div>
        <div class="field">
          <label style="display: block; font-size: 12px; font-weight: 700; color: var(--ink); margin-bottom: 6px;">종료일</label>
          <input type="date" id="voteCreateEndDate" value="2026-07-05" style="width: 100%; border: 1px solid var(--line); background: #ffffff; padding: 10px 12px; border-radius: 8px; font-size: 13px; outline: none; font-weight: 500;">
        </div>
      </div>

      <div style="display: flex; gap: 10px;">
        <button class="primary" id="voteCreateSubmitBtn" style="flex: 1; padding: 12px; font-weight: 700; font-size: 13.5px; background: var(--dark) !important; border-radius: 8px; color: #ffffff; border: none; cursor: pointer;">등록</button>
        <button class="secondary" id="voteCreateCancelBtn" style="flex: 1; padding: 12px; font-weight: 700; font-size: 13.5px; border: 1px solid var(--line) !important; background: var(--cream) !important; border-radius: 8px; color: var(--ink); border: none; cursor: pointer;">취소</button>
      </div>
    </div>
  `,
  );
...
function bindVoteCreateEvents() {
  const optionsField = $("#voteOptionsField");

  const radios = $$("input[name='voteType']");
  radios.forEach((r) => {
    r.onchange = () => {
      if (r.value === "single" || r.value === "multiple") {
  ...
  const cancelBtn = $("#voteCreateCancelBtn");
  if (cancelBtn) {
    cancelBtn.onclick = () => {
      navigate("vote");
    };
  ...
  const submitBtn = $("#voteCreateSubmitBtn");
  if (submitBtn) {
    submitBtn.onclick = () => {
      const title = $("#voteCreateTitle").value.trim();
      const type = $("input[name='voteType']:checked").value;
      const start = $("#voteCreateStartDate").value;
      const end = $("#voteCreateEndDate").value;

      if (!title) {
        toast("안건 제목을 입력해 주세요.");
        return;
      }
      ...
      if (type === "agree") {
        optionsList = [
          { id: 1, name: "찬성", description: "안건 내용에 찬성합니다." },
          { id: 2, name: "반대", description: "안건 내용에 반대합니다." },
        ];
      } else {
        const rawOptions = $("#voteCreateOptions").value.trim().split("\n");
        const filteredRaw = rawOptions.map((o) => o.trim()).filter(Boolean);
        if (filteredRaw.length < 2) {
          toast("최소 2개 이상의 선택 항목을 입력해 주세요.");
          return;
        }
        optionsList = filteredRaw.map((o, idx) => ({
          id: idx + 1,
          name: o,
          description: "",
        }));
      ...
      toast("새 전자투표 안건이 성공적으로 등록되었습니다. 🗳️");
...
function voteDetail() {
  ...
  if (item.status === "done") {
    formHtml = `
      <div style="background: #faf8f5; border-radius: 8px; border: 1px solid var(--line); padding: 14px 16px; display: flex; flex-direction: column; gap: 12px; margin-top: 12px;">
        ...
        ${item.options
          .map((opt) => {
            const isWinner =
              opt.name.includes("A엘리베이터") ||
              opt.name.includes("찬성") ||
              opt.name.includes("1번");
    ...
    if (item.type === "multiple") {
      selectedText = item.options
        .filter((o) => (item.votedOptionIds || []).includes(o.id))
        .map((o) => o.name)
        .join(", ");
    } else {
      const mySelected =
        item.options.find((o) => o.id === item.votedOptionId) ||
        item.options[0];
      selectedText = mySelected ? mySelected.name : "";
    }
    formHtml = `
      <div style="background: #faf8f5; border-radius: 8px; border: 1px solid var(--line); padding: 14px 16px; text-align: center; color: var(--olive); font-size: 13px; font-weight: 700; display: flex; flex-direction: column; gap: 8px; margin-top: 12px;">
        ...
        <div style="font-size: 12px; color: var(--sub); font-weight: 500;">선택하신 항목: [ ${selectedText || "없음"} ]</div>
      </div>
    `;
  } else {
    const inputType = item.type === "multiple" ? "checkbox" : "radio";
    const nameAttr =
      item.type === "multiple" ? "voteSelections" : "voteSelection";
    formHtml = `
      <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 12px;">
        <div style="font-size: 12px; font-weight: 700; color: var(--sub); margin-bottom: 4px;">투표 선택지${item.type === "multiple" ? " (복수 선택 가능)" : ""}</div>
        ${item.options
          .map(
            (opt) => `
          <label style="display: flex; align-items: flex-start; gap: 10px; background: #ffffff; border: 1px solid var(--line); padding: 12px 14px; border-radius: 8px; cursor: pointer; transition: all 0.2s ease;">
            <input type="${inputType}" name="${nameAttr}" value="${opt.id}" style="margin-top: 3px; accent-color: var(--olive);">
...
function bindVoteDetailEvents() {
  ...
  if (submitBtn) {
    submitBtn.onclick = () => {
      ...
      if (item.type === "multiple") {
        const checkedBoxes = $$("input[name='voteSelections']:checked");
        if (checkedBoxes.length === 0) {
          toast("투표하실 항목을 최소 하나 이상 선택해 주세요.");
          return;
        }
        const optIds = checkedBoxes.map((cb) => parseInt(cb.value));
        item.myVoted = true;
        item.votedOptionIds = optIds;
        item.votedCount += 1;
...
function clubJoinApply() {
  if (!selectedClubToJoin) {
    selectedClubToJoin = availableClubs[0];
  }

  const headerHtml = `
    <div class="meeting-write-header" style="display: flex; justify-content: space-between; align-items: center; padding: 8px 4px; border-bottom: 2px solid var(--dark); margin-bottom: 20px;">
      <button id="clubJoinBackBtn" style="background: none; border: none; font-size: 16px; color: var(--ink); cursor: pointer; display: flex; align-items: center; padding: 0;">
        <i class="fi fi-rr-arrow-left" style="font-weight: 700;"></i>
      </button>
      <h2 style="font-size: 15px; font-weight: 700; color: var(--ink); margin: 0;">소모임 가입 신청</h2>
      <button id="clubJoinMenuBtn" style="background: none; border: none; font-size: 16px; color: var(--ink); cursor: pointer; display: flex; align-items: center; padding: 0;">
        <i class="fi fi-rr-menu-burger" style="font-weight: 700;"></i>
      </button>
    </div>
  `;

  return `<section class="page" style="padding: 16px;">
    ${headerHtml}
    
    <div style="font-size: 13px; font-weight: 700; color: var(--ink); margin: 16px 0 8px 4px;">[ 신청할 소모임 정보 ]</div>
    <div class="card" style="border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow); padding: 16px; margin-bottom: 20px; display: flex; flex-direction: column; gap: 8px;">
      <div style="display: flex; justify-content: space-between; align-items: start; gap: 8px;">
        <span style="font-weight: 700; font-size: 14.5px; color: var(--ink);">${selectedClubToJoin.name}</span>
        <span style="font-size: 11.5px; font-weight: 700; color: var(--sub); background: var(--cream); padding: 3px 8px; border-radius: 6px; border: 1px solid var(--line);">정원: [ ${selectedClubToJoin.members}명 / ${selectedClubToJoin.maxMembers}명 ]</span>
      </div>
      <div style="font-size: 12px; color: var(--sub); font-weight: 500; line-height: 1.5;">- 소개: ${selectedClubToJoin.desc}</div>
    </div>
    
    <div style="font-size: 13px; font-weight: 700; color: var(--ink); margin: 16px 0 8px 4px;">[ 가입 신청서 작성 ]</div>
    <div class="card" style="border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow); overflow: hidden; display: flex; flex-direction: column; margin-bottom: 20px;">
      <div style="display: flex; align-items: center; padding: 12px 16px; gap: 12px; border-bottom: 1px solid var(--line);">
        <span style="font-size: 12.5px; font-weight: 700; color: var(--sub); width: 80px; white-space: nowrap;">신청자명</span>
        <input type="text" id="clubJoinApplicantName" value="김하늘" placeholder="이름을 입력하세요." style="flex: 1; border: 1px solid var(--line); background: #ffffff; padding: 8px 12px; border-radius: 8px; font-size: 12.5px; font-weight: 500; color: var(--ink); outline: none;">
      </div>
      
      <div style="display: flex; align-items: center; padding: 12px 16px; gap: 12px; border-bottom: 1px solid var(--line);">
        <span style="font-size: 12.5px; font-weight: 700; color: var(--sub); width: 80px; white-space: nowrap;">거주지</span>
        <input type="text" id="clubJoinResidence" value="101동 1302호" placeholder="동/호수를 입력하세요." style="flex: 1; border: 1px solid var(--line); background: #ffffff; padding: 8px 12px; border-radius: 8px; font-size: 12.5px; font-weight: 500; color: var(--ink); outline: none;">
      </div>
    </div>
    
    <div class="card" style="border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow); padding: 14px 16px; margin-bottom: 20px;">
      <label style="font-size: 12.5px; font-weight: 700; color: var(--sub); display: block; margin-bottom: 8px;">가입 각오 및 자기 소개</label>
      <textarea id="clubJoinGreeting" placeholder="소모임 멤버들과 모임장에게 보여질 첫인사 및 소개를 50자 내외로 입력해 주세요." style="width: 100%; height: 120px; border: 1px solid var(--line); border-radius: 8px; padding: 12px; font-size: 12.5px; font-weight: 500; color: var(--ink); outline: none; resize: none; line-height: 1.6; font-family: inherit;"></textarea>
    </div>
    
    <button class="primary" id="clubJoinSubmitBtn" style="width: 100%; padding: 14px; font-weight: 700; font-size: 14px; background: var(--dark) !important; border-radius: 12px; color: #ffffff; border: none; cursor: pointer; transition: opacity 0.2s ease; margin-bottom: 24px;">
      신청서 완료하기
    </button>
  </section>`;
}

function bindClubJoinApplyEvents() {
  const backBtn = $("#clubJoinBackBtn");
  if (backBtn) {
    backBtn.onclick = () => {
      navigate("community");
    };
  ...
  const submitBtn = $("#clubJoinSubmitBtn");
  if (submitBtn) {
    submitBtn.onclick = () => {
      const applicantName = $("#clubJoinApplicantName").value.trim();
      const residence = $("#clubJoinResidence").value.trim();
      const greeting = $("#clubJoinGreeting").value.trim();

      if (!applicantName || !residence || !greeting) {
        toast("모든 입력 요소를 채워주세요.");
        return;
      }

      if (selectedClubToJoin) {
        selectedClubToJoin.status = "pending";
        toast(`“${selectedClubToJoin.name}” 가입 신청을 완료했습니다.`);
      } else {
        toast("가입 신청이 처리되었습니다.");
      }
...
function officeInfo() {
  return simplePage("관리사무소 안내", "단지 관리 및 생활 민원 지원 서비스를 안내합니다.", `
    <!-- 영업 시간 카드 -->
    <div class="card" style="padding: 20px; margin-bottom: 16px; border-radius: 12px; border: 1px solid var(--line); box-shadow: var(--shadow);">
      <h3 style="font-size: 14px; font-weight: 700; color: var(--ink); margin-bottom: 12px; display: flex; align-items: center; gap: 8px;">
        <i class="fi fi-rr-clock" style="color: var(--olive); font-size: 16px;"></i> 영업 시간 안내
      </h3>
      <div style="font-size: 13.5px; color: var(--ink); display: flex; flex-direction: column; gap: 8px; line-height: 1.5;">
        <div style="display: flex; justify-content: space-between;">
          <span style="font-weight: 600; color: var(--sub);">평일 근무</span>
          <span style="font-weight: 700;">09:00 ~ 18:00</span>
        </div>
        <div style="display: flex; justify-content: space-between;">
          <span style="font-weight: 600; color: var(--sub);">점심시간</span>
          <span style="font-weight: 700;">12:00 ~ 13:00</span>
        </div>
        <div style="display: flex; justify-content: space-between;">
          <span style="font-weight: 600; color: var(--sub);">토요일 / 일요일 / 공휴일</span>
          <span style="font-weight: 700; color: #d64545;">휴무</span>
        </div>
        <div style="height: 1px; background: var(--line); margin: 6px 0;"></div>
        <p style="font-size: 11.5px; color: var(--sub); font-weight: 500; margin: 0; line-height: 1.4;">
          * 주말 및 야간 긴급 하자 상황 발생 시에는 아래의 <b>보안실</b> 또는 <b>기계/방재실</b>로 즉시 연락해 주시기 바랍니다.
        </p>
      </div>
    </div>

    <!-- 연락처 및 업무 목록 카드 -->
    <div class="section-head" style="margin-top: 20px; margin-bottom: 10px;">
      <h2>부서별 연락처</h2>
    </div>
    <div class="card" style="border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow); overflow: hidden; display: flex; flex-direction: column;">
      
      <!-- 대표 전화 -->
      <div class="call-row" data-tel="02-1234-5678" style="padding: 16px; border-bottom: 1px solid var(--line); display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: background 0.2s ease;">
        <div>
          <b style="font-size: 13.5px; display: block; color: var(--ink);">관리사무소 대표번호</b>
          <small style="font-size: 11.5px; color: var(--sub); display: block; margin-top: 2px;">입주등록, 차량 관리, 행정 문의</small>
        </div>
        <div style="display: flex; align-items: center; gap: 8px;">
          <span style="font-family: var(--font-mono); font-weight: 700; font-size: 13.5px; color: var(--olive);">02-1234-5678</span>
          <button style="width: 28px; height: 28px; border-radius: 50%; background: #eff2e5; color: var(--olive); display: grid; place-items: center; border: none; font-size: 12px;"><i class="fi fi-rr-phone-call"></i></button>
        </div>
      </div>

      <!-- 보안실 -->
      <div class="call-row" data-tel="02-1234-5680" style="padding: 16px; border-bottom: 1px solid var(--line); display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: background 0.2s ease;">
        <div>
          <b style="font-size: 13.5px; display: block; color: var(--ink);">통합 보안실 (24시간)</b>
          <small style="font-size: 11.5px; color: var(--sub); display: block; margin-top: 2px;">순찰, 단지 보안, 주차 민원, 긴급 상황</small>
        </div>
        <div style="display: flex; align-items: center; gap: 8px;">
          <span style="font-family: var(--font-mono); font-weight: 700; font-size: 13.5px; color: var(--olive);">02-1234-5680</span>
          <button style="width: 28px; height: 28px; border-radius: 50%; background: #eff2e5; color: var(--olive); display: grid; place-items: center; border: none; font-size: 12px;"><i class="fi fi-rr-phone-call"></i></button>
        </div>
      </div>

      <!-- 기계실/방재실 -->
      <div class="call-row" data-tel="02-1234-5681" style="padding: 16px; border-bottom: 1px solid var(--line); display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: background 0.2s ease;">
        <div>
          <b style="font-size: 13.5px; display: block; color: var(--ink);">기계실 / 방재실</b>
          <small style="font-size: 11.5px; color: var(--sub); display: block; margin-top: 2px;">수도/누수, 보일러, 엘리베이터 점검</small>
        </div>
        <div style="display: flex; align-items: center; gap: 8px;">
          <span style="font-family: var(--font-mono); font-weight: 700; font-size: 13.5px; color: var(--olive);">02-1234-5681</span>
          <button style="width: 28px; height: 28px; border-radius: 50%; background: #eff2e5; color: var(--olive); display: grid; place-items: center; border: none; font-size: 12px;"><i class="fi fi-rr-phone-call"></i></button>
        </div>
      </div>

      <!-- 야간 당직실 -->
      <div class="call-row" data-tel="02-1234-5682" style="padding: 16px; display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: background 0.2s ease;">
        <div>
          <b style="font-size: 13.5px; display: block; color: var(--ink);">야간 / 휴일 당직실</b>
          <small style="font-size: 11.5px; color: var(--sub); display: block; margin-top: 2px;">정규 업무 외 시간 긴급 상황 접수</small>
        </div>
        <div style="display: flex; align-items: center; gap: 8px;">
          <span style="font-family: var(--font-mono); font-weight: 700; font-size: 13.5px; color: var(--olive);">02-1234-5682</span>
          <button style="width: 28px; height: 28px; border-radius: 50%; background: #eff2e5; color: var(--olive); display: grid; place-items: center; border: none; font-size: 12px;"><i class="fi fi-rr-phone-call"></i></button>
        </div>
      </div>
    ...
    <!-- 위치 카드 -->
    <div class="card" style="padding: 20px; margin-top: 16px; margin-bottom: 20px; border-radius: 12px; border: 1px solid var(--line); box-shadow: var(--shadow);">
      <h3 style="font-size: 14px; font-weight: 700; color: var(--ink); margin-bottom: 8px; display: flex; align-items: center; gap: 8px;">
        <i class="fi fi-rr-map-marker-home" style="color: var(--olive); font-size: 16px;"></i> 위치 안내
      </h3>
      <p style="font-size: 13px; color: var(--ink); font-weight: 500; margin: 0; line-height: 1.5;">
        단지 중앙 <b>커뮤니티 센터 지하 1층</b> (피트니스 센터 및 골프룸 복도 입구 맞은편)
      </p>
    </div>

    <!-- 민원 접수 버튼 링크 -->
    <button class="primary" id="goToComplaintBtn" style="width: 100%; padding: 14px; font-weight: 700; font-size: 14px; background: var(--dark) !important; border-radius: 12px; color: #ffffff; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px;">
      <i class="fi fi-rr-tools"></i> 생활 불편 민원 접수하러 가기
    </button>
  `);
}

function bindOfficeInfoEvents() {
  // 전화 걸기 액션 연동
  $$(".call-row").forEach(row => {
    row.onclick = () => {
      const telNum = row.dataset.tel;
      const deptName = row.querySelector("b").textContent;
      toast(`“${deptName}” (${telNum}) 번호로 전화 연결을 시작합니다.`);
      // Mock call popup for previewing
      setTimeout(() => {
        openModal(`
          <div style="text-align: center; padding: 10px;">
            <div style="width: 60px; height: 60px; border-radius: 50%; background: #eff2e5; color: var(--olive); display: grid; place-items: center; font-size: 24px; margin: 0 auto 16px;">
              <i class="fi fi-rr-phone-call"></i>
            </div>
            <h2 style="font-size: 16px; font-weight: 700; margin-bottom: 8px; color: var(--ink);">${deptName}</h2>
            <p style="font-family: var(--font-mono); font-size: 18px; font-weight: 700; color: var(--olive); margin-bottom: 20px;">${telNum}</p>
            <p style="font-size: 12px; color: var(--sub); margin-bottom: 24px;">모바일 기기에서는 실제로 전화 앱으로 연결됩니다.</p>
            <button onclick="closeModal()" style="width: 100%; padding: 12px; font-weight: 700; font-size: 13px; background: var(--dark) !important; color: #ffffff; border: none; border-radius: 8px; cursor: pointer;">확인</button>
          </div>
        `);
      }, 500);
    };
  ...
  // 민원 접수로 가기
  const complaintBtn = $("#goToComplaintBtn");
  if (complaintBtn) {
...
const faqData = [
  {
    category: "facility",
    q: "피트니스 센터나 독서실은 어떻게 예약하나요?",
    a: "생활 서비스 > '시설예약' 메뉴에서 이용 희망 날짜와 시간을 지정한 후 간편하게 예약하실 수 있습니다. 예약이 완료되면 마이페이지 또는 예약 내역에서 스마트키(QR)를 확인할 수 있으며, 이용 시간 10분 전부터 게이트 리더기에 접촉하여 입장하실 수 있습니다."
  },
  {
    category: "fee",
    q: "관리비 고지서 발행일과 납부 마감일은 언제인가요?",
    a: "매달 15일에 당월 고지서가 시스템 및 종이 고지서로 발행되며, 납부 마감일은 매달 25일입니다. 은행 자동이체 신청을 하신 경우 25일에 자동 출금됩니다. 기한을 넘길 경우 연체료가 부과될 수 있으니 꼭 기한 내 납부를 부탁드립니다."
  },
  {
    category: "parking",
    q: "외부 방문 차량 등록은 어떻게 하나요?",
    a: "생활 서비스 > '방문차량 등록' 메뉴를 통해 차량번호, 방문일, 목적을 작성하여 즉시 등록할 수 있습니다. 등록이 완료된 차량은 정문 차단기를 자동으로 통과할 수 있으며 별도의 경비실 대기 없이 출입이 가능합니다. 자주 오는 단골 차량은 체크 박스를 눌러 즐겨찾기에 등록해 두면 다음 등록 시 더욱 편리합니다."
  },
  {
    category: "smarthome",
    q: "조명이나 가스 밸브 제어가 앱에서 반응하지 않을 땐 어떻게 하나요?",
    a: "세대 내부 신발장 또는 복도 벽면에 위치한 스마트홈 메인 게이트웨이 기기의 리셋 스위치를 재부팅(껐다 켜기) 해보시기 바랍니다. 재부팅 후에도 지속적으로 제어 오류가 발생할 경우, 관리사무소 안내 메뉴를 확인하시어 기계실/방재실(02-1234-5681)로 기술 점검 민원을 접수해 주십시오."
  },
  {
    category: "facility",
    q: "소모임을 직접 개설하고 싶은데 자격 조건이 있나요?",
    a: "본 아파트 단지에 실거주 중인 인증 입주민이라면 누구나 자유롭게 소모임을 개설하고 멤버를 모집할 수 있습니다. '커뮤니티' 메뉴 하단의 '새로운 소모임 만들기'를 통해 개설하실 수 있습니다. 단, 단지 관리 규약 및 공공 위생/안전에 위배되거나 상업 목적 광고, 음란성 소모임의 경우 관리자에 의해 비활성화 또는 폐쇄될 수 있습니다."
  },
  {
    category: "parking",
    q: "세대당 무료 주차 대수 및 추가 주차 요금은 어떻게 되나요?",
    a: "우리 단지는 세대당 1대까지 무료 주차가 지원됩니다. 2대째 추가 등록 시 월 20,000원, 3대째 등록 시 월 50,000원의 추가 요금이 부과되며 관리비 계정에 합산 고지됩니다. 세대당 최대 3대까지만 등록이 가능하며, 추가 등록 신청은 관리사무소 창구를 방문해 주셔야 합니다."
  }
];
...
function faq() {
  const categories = [
    { id: "all", label: "전체" },
    { id: "facility", label: "커뮤니티/시설" },
    { id: "fee", label: "관리비" },
    { id: "parking", label: "주차/차량" },
    { id: "smarthome", label: "스마트홈/제어" }
  ];

  const categoryChips = categories.map(cat => 
    `<button class="chip faq-chip ${currentFaqCategory === cat.id ? "active" : ""}" data-category="${cat.id}" style="font-size: 12px; font-weight: 700; cursor: pointer; transition: all 0.2s;">${cat.label}</button>`
  ).join("");
  ...
  const faqListHtml = filteredFaq.map((item, idx) => `
    <div class="faq-item" style="border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow); margin-bottom: 12px; overflow: hidden; display: flex; flex-direction: column;">
      <!-- 질문 클릭 영역 -->
      <div class="faq-question-btn" style="padding: 16px; display: flex; justify-content: space-between; align-items: center; cursor: pointer; transition: background 0.2s ease; user-select: none;">
        <span style="font-size: 13.5px; font-weight: 700; color: var(--ink); text-align: left; line-height: 1.4; display: flex; align-items: start; gap: 8px;">
          <span style="color: var(--olive); font-weight: 800;">Q.</span>
          <span>${item.q}</span>
        </span>
        <i class="fi fi-rr-angle-small-down faq-chevron" style="font-size: 16px; color: var(--sub); transition: transform 0.25s ease;"></i>
      </div>
      <!-- 답변 표시 영역 (기본 숨김) -->
      <div class="faq-answer-panel" style="max-height: 0; overflow: hidden; transition: max-height 0.25s cubic-bezier(0.4, 0, 0.2, 1); background: #faf9f6;">
        <div style="padding: 16px; font-size: 12.5px; color: var(--sub); font-weight: 500; line-height: 1.6; border-top: 1px solid var(--line); display: flex; align-items: start; gap: 8px;">
          <span style="color: var(--dark); font-weight: 800;">A.</span>
          <span style="flex: 1;">${item.a}</span>
        </div>
      </div>
    </div>
  `).join("");

  const emptyHtml = `<div class="card" style="padding: 24px; text-align: center; color: var(--sub); font-size: 12.5px;">등록된 질문이 없습니다.</div>`;

  return `<section class="page">${pageTitle("자주 묻는 질문", "입주민들이 가장 자주 묻는 질문과 답변입니다.")}
    <!-- 카테고리 탭 -->
    <div class="chips" style="margin-bottom: 16px; padding: 2px 0;">
      ${categoryChips}
    </div>
    
    <!-- 질문 리스트 -->
    <div class="faq-list-container">
      ${filteredFaq.length > 0 ? faqListHtml : emptyHtml}
    </div>
  </section>`;
}
...
function bindFaqEvents() {
  ...
  // 아코디언 토글 이벤트
  $$(".faq-question-btn").forEach(btn => {
    btn.onclick = () => {
      const panel = btn.nextElementSibling;
      const chevron = btn.querySelector(".faq-chevron");
      const isOpen = panel.style.maxHeight !== "" && panel.style.maxHeight !== "0px";
      
      // 먼저 모든 아코디언을 닫아줍니다 (단일 확장 모드)
      $$(".faq-answer-panel").forEach(p => {
        p.style.maxHeight = "0px";
      });
      $$(".faq-chevron").forEach(c => {
        c.style.transform = "rotate(0deg)";
      });
      $$(".faq-question-btn").forEach(q => {
...
function generic() {
  return simplePage(
    "서비스 준비 중",
    "더 좋은 경험을 준비하고 있어요.",
    `<article class="card report-card"><h3>곧 만나요</h3><p>이 메뉴는 화면 구성 확인을 위한 준비 상태입니다.</p></article>`,
  );
}

function board() {
  const query = boardSearchQuery.trim().toLowerCase();
  const results = boardPosts.filter(
    (post) =>
  ...
  const searchNotice = query
    ? `* 검색 결과: '${boardSearchQuery}'에 대한 결과가 총 ${results.length}건 있습니다.`
    : `* 전체 게시글 목록이 총 ${results.length}건 있습니다.`;
...
function boardDetail() {
  const post =
    boardPosts.find((x) => x.id === currentBoardPostId) || boardPosts[0];
  ...
  const isAuthor =
    post.author === "주민B (102동)" || post.author.includes("익명");
  const authorActionsHtml = isAuthor
    ? `
        ...
        <div class="card" style="padding: 16px; border-radius: 12px; background: #ffffff; border: 1px solid var(--line); box-shadow: var(--shadow);">
          ...
          <div id="boardDetailCommentsList" style="display: flex; flex-direction: column; gap: 10px;">
            ...
            `,
                    ...
                    .join("")
                : `<p style="font-size: 12.5px; color: var(--sub); text-align: center; margin: 0; padding: 12px 0;">첫 댓글을 남겨보세요!</p>`
            }
          </div>
...
function navigate(next) {
  route = renders[next] ? next : "home";
  $("#app").innerHTML = renders[route]();
  $$(".nav-item").forEach((b) =>
    b.classList.toggle("active", b.dataset.route === route),
  );
  $$(".desktop-menu .drawer-link").forEach((b) =>
    b.classList.toggle("active", b.dataset.route === route),
  );
...
function bind() {
  ...
  if (homeDoorBtn) {
    homeDoorBtn.onclick = () => {
      ...
      if (visualEl)
        visualEl.innerHTML = icon(deviceState.door ? "lock" : "unlock");
      if (statusEl)
        statusEl.textContent = deviceState.door ? "안전하게 잠김" : "열려 있음";
  ...
  if (homeAcSwitch) {
    homeAcSwitch.onclick = () => {
      ...
      toast(
        deviceState.ac ? "에어컨 전원을 켰습니다." : "에어컨 전원을 꿨습니다.",
      );
    };
  }
    ...
    (b) =>
      (b.onclick = () => {
        if (b.id !== "homeAcSwitch" && !b.id.endsWith("Switch")) {
          ...
          toast(
            b.classList.contains("on") ? "전원을 켰어요." : "전원을 꿨어요.",
          );
        }
      }),
  );

  $$(".chip:not(.fac-chip)").forEach(
    (b) =>
      (b.onclick = () => {
        $$(".chip:not(.fac-chip)").forEach((x) => x.classList.remove("active"));
        b.classList.add("active");
      }),
  );
  ...
  if (route === "voteCreate") bindVoteCreateEvents();
  ...
  if (route === "clubJoinApply") bindClubJoinApplyEvents();
  if (route === "officeInfo") bindOfficeInfoEvents();
  if (route === "faq") bindFaqEvents();
  ...
  const search = $("#searchCar");
  if (search)
    search.onclick = () => {
      $("#carResult").innerHTML =
        '<div class="notice" style="margin-top:14px"><b>조회 완료</b><span>지하 2층 B-24 구역에 주차되어 있어요.</span></div>';
    };
  $$(".notice-detail").forEach(
    (b) =>
      (b.onclick = () => {
  ...
  $$(".mode").forEach(
    (b) =>
      (b.onclick = () =>
        toast(`${b.querySelector("h3").textContent}를 실행했어요.`)),
  );
...
$("#drawerMenu").innerHTML =
  menu
    .map(
      ([g, items]) =>
        `<div class="drawer-group"><h3>${g}</h3><div class="card">${items.map((x) => `<button class="drawer-link" data-route="${x[1]}">${x[0]}</button>`).join("")}</div></div>`,
    )
    .join("") +
  `<p class="icon-credit">Icons by <a href="https://www.flaticon.com/uicons" target="_blank" rel="noreferrer">Flaticon UIcons</a></p>`;
$("#desktopMenu").innerHTML =
  `<div class="drawer-group"><h3>메인</h3><div class="card"><button class="drawer-link" data-route="home">홈</button></div></div>` +
  menu
    .map(
      ([g, items]) =>
        `<div class="drawer-group"><h3>${g}</h3><div class="card">${items.map((x) => `<button class="drawer-link" data-route="${x[1]}">${x[0]}</button>`).join("")}</div></div>`,
...
$("#alarmButton").onclick = () => navigate("notice");
...
function setupHoverAutoScroll() {
  ...
  $$(".hover-scroll-panel").forEach((panel) => {
    ...
    panel.addEventListener("mousemove", (e) => {
      ...
      const edge = Math.min(100, rect.height * 0.18);
      if (y < edge) speed = -Math.max(1, (edge - y) / 12);
      else if (y > rect.height - edge)
        speed = Math.max(1, (y - (rect.height - edge)) / 12);
      else speed = 0;
    });
...
function updateScrollHint() {
  ...
  const atBottom =
    centerScroll.scrollTop + centerScroll.clientHeight >=
    centerScroll.scrollHeight - 3;
  ...
  if (scrollTopHint)
    scrollTopHint.classList.toggle("hidden", !canScroll || !atBottom);
}
if (centerScroll && scrollHint) {
  scrollHint.onclick = () => {
    centerScroll.scrollBy({
      top: centerScroll.clientHeight * 0.82,
      behavior: "smooth",
    });
  };
  if (scrollTopHint)
    scrollTopHint.onclick = () => {
      centerScroll.scrollTo({ top: 0, behavior: "smooth" });
    };
  centerScroll.addEventListener("scroll", updateScrollHint, { passive: true });
  window.addEventListener("resize", updateScrollHint);
  new MutationObserver(() => requestAnimationFrame(updateScrollHint)).observe(
    centerScroll,
...
if (chatAssist && chatInput) {
  chatAssist.addEventListener("mouseenter", () => {
    setTimeout(() => {
      if (chatAssist.matches(":hover")) chatInput.focus();
    }, 280);
  });
